...
Необходимо создать папку data и загрузить туда необходимые данные. Также, необходимо создать виртуальное окружение, активировать его и загрузить необходимые пакеты.
```bash
python -m venv .venv
